...
public class MirrorClient {
  ...
  public static Subscription insertSubscription(Credential credential, String callbackUrl,
      String userId, String collection) throws IOException {
        ...
        LOG.info("Attempting to subscribe userId: " + userId + " with callback: " + callbackUrl);
        ...
        subscription.setVerifyToken("everydaygoogleglasstweettimelineitem");
        subscription.setOperation(Collections.singletonList("UPDATE"));
